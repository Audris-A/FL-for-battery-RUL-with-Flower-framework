...
class DPFedAvgFixed(Strategy):
    ...
    # Audris: Added this method from the source for debugging the noise addition to 
    #   try to get the hyperparamaters right for DP noise addition. 
    def add_gaussian_noise(self, update, std_dev: float):
