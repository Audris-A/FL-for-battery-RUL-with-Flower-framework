...
class CustomFedAvg(Strategy):
    ...
    def __repr__(self) -> str:
        rep = f"CustomFedAvg(accept_failures={self.accept_failures})"
        return rep
    ...
    def num_fit_clients(self, num_available_clients: int) -> Tuple[int, int]:
        ...
        log(INFO, "num fit clients = " + str(num_clients))
    ...
    def num_evaluation_clients(self, num_available_clients: int) -> Tuple[int, int]:
        ...
        log(INFO, "num evaluation clients = " + str(num_clients))
    ...
    def aggregate_fit(
        ...
        for _, fit_res in results:
            ...
            for enc_byte_obj in fit_res.parameters.tensors:
                ...
                one_client_cypher_results = np.append(one_client_cypher_results, cypher_object)
