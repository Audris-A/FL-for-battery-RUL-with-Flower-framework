...
class DPFedAvgFixed(Strategy):
    ...
    def __init__(
        ...
        log(INFO, "set nm = " + str(self.noise_multiplier))
    ...
    def _calc_client_noise_stddev(self) -> float:
        log(INFO, str(self.noise_multiplier))
        log(INFO, str(self.clip_norm))
        log(INFO, str(self.num_sampled_clients))
    ...
    def aggregate_fit(
        ...
        # Audris: Commented out DP on the server side for applying DP only on the client side
