...
from DP_client import DPFedAvgNumPyClient
...
fl.client.start_numpy_client(server_address="localhost:8080", client=DPFedAvgNumPyClient(BatteryClient(CNN_client_model, 
                                                                                                       test_x, 
                                                                                                       test_y, 
                                                                                                       train_x, 
                                                                                                       train_y, 
